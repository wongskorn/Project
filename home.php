...
<body>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient sidebar sidebaraccordion" id="accordionSidebar"
            ...
            <li class="nav-item active">
                <a class="nav-link" href="MyProfile.php?id=<?php echo $_SESSION['MenberID'] ?>" >
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">New Cartoon</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card">
                                <div class="card-body">
                                <a href="Detailinpost.php?post_id=<?php echo $post['post_id']?>" >
