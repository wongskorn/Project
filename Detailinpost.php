            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                        ...
                        <div class="col-xl-12 col-md-12 mb-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h5>เรทความเหมาะสม <?php echo  $post['post_rate']?> </h5>
                                    <div class="row">
                                    <h5>แนว : &emsp;</h5>
                                    <?php
                            $id = $_GET["post_id"];
                            include "dblink.php";
                            $sql2 = "SELECT * FROM post_type,type  where post_type.post_id  = $id and post_type.type_id = type.type_id " ;
                            
                            $result2 = mysqli_query($link, $sql2);
                            while($post2 = mysqli_fetch_array($result2)) 
                            { 
                        ?>
                                    <h5><?php echo  $post2['type_name']?>&emsp;</h5>
                                    <?php 
                                      }
                                      ?>
                                      </div>
                        ...
                        <center> <textarea class="form-control col-8" name="detail" id="" cols="80" rows="10" >  <?php echo  $post['post_detail']?>  </textarea>   </center>
                        <?php    
                            }
                            ?>
